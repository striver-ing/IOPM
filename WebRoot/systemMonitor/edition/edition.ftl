...
<html lang="en">
	...
	<head>
		...
		<!-- ================== END BASE JS ================== -->
		<link rel="stylesheet" href="../jiaoben5111/css/screen.css" type="text/css" media="screen">
		<link rel="stylesheet" href="../jiaoben5111/css/responsive.css" type="text/css" media="screen">
		<link rel="stylesheet" href="../jiaoben5111/inc/colorbox.css" type="text/css" media="screen">
	</head>
	...
	<body>
		...
		<!-- begin #content -->
			<div id="content" class="content" style="margin:0;padding:0;">
				...
				<div class="panel panel-inverse">
					<div class="panel-body box-body"">
						<div class="container">
							<!--<h1>版本监控</h1>-->
							<!--<p class="lead">本页包含两工作实例，说明几个关键特征包括展开/折叠，自动启动/加载，每页的多个时间线。</p>-->
			...
			<script src="js/edition.js" type="text/javascript" charset="utf-8"></script>
			<!-- ================== BEGIN private JS ================== -->
			<!-- GLOBAL CORE SCRIPTS -->
			
			<script type="text/javascript" src="../jiaoben5111/inc/colorbox.js"></script>
			<script type="text/javascript" src="../jiaoben5111/js/timeliner.min.js"></script>
			<script>
